DROP VIEW IF EXISTS CERT_EXAM_VW;

CREATE VIEW CERT_EXAM_VW AS
SELECT E.EXAM_CENTER,  E.CANDIDATE_EMAIL, E.FIRST_NAME, E.LAST_NAME, E.COMPANY_NAME,
IFNULL(M.REGION,'UNKNOWN REGION') REGION, IFNULL(M.COUNTRY,'') COUNTRY, E.EXAM_CODE, E.EXAM_NAME,
...
ON E.COUNTRY_CODE = M.ABBREVIATION;

DROP PROCEDURE IF EXISTS MERGE_STAGE_2_MAIN;
